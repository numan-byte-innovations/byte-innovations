  ...
  { label: "MVP Calculator", href: "/mvp-calculator" },
  {
    ...
    mega: {
      cards: [
        ...
        { title: "Team Augmentation", description: "A full dev team set up alongside yours in days.", href: "/team-augmentation" },
        { title: "MVP Service", description: "Idea to live product in weeks, not months." },
        { title: "AI & Machine Learning", description: "AI and machine learning solutions tailored to your business needs.", href: "/ai-machine-learning" },
      ...
      columns: [
        ...
        { heading: "Team Augmentation", href: "/team-augmentation", links: ["About Team Augmentation", "Benefits of Staff Augmentation", "Partnership Models", "How Our Staff Augmentation Works"] },
        ...
        { heading: "AI & Machine Learning", href: "/ai-machine-learning", links: ["AI Strategy Development", "AI Agent Development", "AI Product Development", "Conversational AI", "RAG AI Development", "Data & LLM Engineering"] },
